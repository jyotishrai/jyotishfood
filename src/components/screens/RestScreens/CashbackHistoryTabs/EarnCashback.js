...
import { getEarnedCashbackHistoryAction } from '../../../../actions/action'
...
const EarnCashbackScreen = ({ navigation }) => {
    ...
    const { earnedCashbackHistory, fetching, error } = useSelector(state => ({
        earnedCashbackHistory: state.getCashbackHistoryReducer.earnedCashbackHistory,
    ...
    function getEarnedCashback() {
        dispatch(getEarnedCashbackHistoryAction({ page: 1 }))
    }
    ...
    return (
        <View style={styles.mainViewStyle}>
            {
                earnedCashbackHistory != undefined &&
                <FlatList
                    data={earnedCashbackHistory.response}
